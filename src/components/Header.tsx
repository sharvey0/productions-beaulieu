        ...
        <header
            ...
            {!showOnlyLogo &&
                <div className="flex flex-col lg:flex-row items-center">
                    <nav
                        className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2 lg:gap-x-10 lg:absolute lg:left-1/2 lg:-translate-x-1/2">
                        <Link href="/"
                    ...
                    <div className="flex items-center gap-5 lg:mt-0 mt-3">
                        <Link href="mailto:productionsbeaulieu@gmail.com" target="_blank"
                              className="w-8 h-8 lg:w-10 lg:h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-black transition-all">
                            <MdEmail size={14}/>
                        </Link>
                        <Link href="https://www.instagram.com/productions_beaulieu/" target="_blank"
                              className="w-8 h-8 lg:w-10 lg:h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-black transition-all">
                            <FaInstagram size={16}/>
                        </Link>
                        <Link href="/account"
