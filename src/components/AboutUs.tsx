            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="flex flex-col space-y-8">
                        <div>
                            <h2 className="text-[var(--accent)] uppercase tracking-[0.3em] text-sm font-bold mb-4">Notre Histoire</h2>
                        ...
                        <div className="space-y-6 text-zinc-400 text-lg leading-relaxed">
                            <p>
                                Fondé par des passionnés de la scène, Productions Beaulieu est né d&#39;une vision simple :
                                connecter les meilleurs talents musicaux avec ceux qui recherchent une ambiance exceptionnelle.
                            </p>
                            <p>
                                Que ce soit pour un mariage élégant, un événement corporatif d&#39;envergure ou une soirée
                ...
                <div className="mt-32">
                    <h2 className="text-[var(--accent)] uppercase tracking-[0.3em] text-sm font-bold mb-12 text-center">Nos Styles</h2>
